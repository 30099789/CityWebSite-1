...
const users = [
  ...
  { name: "Carol White",   email: "carol@email.com", password: "carol123",  role: "staff"    },
  ...
  { name: "Admin User",    email: "admin@email.com", password: "admin123",  role: "admin"    },
];
...
const announcements = [
  {
    ...
    content:  "Due to the Easter long weekend, bin night for the week of 18–22 April will be moved forward by one day. Please put your bins out the night before your usual collection day. Green waste and recycling are not affected.",
    priority: "high",
    status:   "published",
  ...
  },
  {
    ...
    content:  "Residents can now pay council rates through the new online portal. The system accepts Visa, Mastercard and BPAY. Visit the Rates section of the portal to get started. Paper notices will continue to be sent as usual.",
    priority: "medium",
    status:   "published",
  ...
  },
  {
    ...
    content:  "Council-approved road resurfacing works will take place on High Street between Main Road and Park Avenue from 30 March to 4 April. One lane will remain open at all times. Motorists are advised to allow extra travel time or use alternate routes via Station Road.",
    priority: "high",
    status:   "published",
  ...
  },
  {
    ...
    content:  "CityLink Initiatives is accepting applications for the 2026 Community Grants Program. Grants of up to $5,000 are available for not-for-profit groups running projects that benefit local residents. Applications close 30 April 2026. Download the form from the Services section.",
    priority: "medium",
    status:   "published",
  ...
  },
  {
    ...
    content:  "All CityLink library branches will operate extended hours during January and February to accommodate school-holiday demand. Saturday hours will be extended to 5:00 PM and Sunday openings added from 11:00 AM – 3:00 PM. Normal hours resume in March.",
    priority: "low",
    status:   "published",
...
// Feedback has no model yet — add if you create one. Skipped here.
...
async function seed() {
  try {
    ...
    // ── Bookings (reference real event _ids from DB) ──
    ...
    const bookings = [
      {
        eventId:     evMap["Community Clean-Up Day"]._id,
      ...
      {
        eventId:     evMap["Town Hall Meeting"]._id,
      ...
      {
        eventId:     evMap["Youth Coding Workshop"]._id,
      ...
      {
        eventId:     evMap["Seniors Morning Tea"]._id,
        eventTitle:  "Seniors Morning Tea",

...
const announcements = [
  ...
  },
  {
    ...
    imageUrl: "/images/road-works.jpg",
  },
  {
    ...
    imageUrl: "/images/community-grant.jpg",
  },
  {
    ...
    imageUrl: "/images/library-hours.jpg",
  },
];
...
async function seed() {
  try {
    ...
    const bookings = [
      ...
      { eventId: evMap["Seniors Morning Tea"]._id,     eventTitle: "Seniors Morning Tea",     userName: "Carol White",   userEmail: "carol@email.com", bookingDate: "2026-03-09", status: "Pending"   },
    ];
